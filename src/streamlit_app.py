...
APP_TITLE = "Campus AI Agent 校园智能助理"
APP_ICON = "🧰"
USER_ID_COOKIE = "user_id"
APP_DESCRIPTION = "一个面向大学生校园场景的 AI Agent，支持课程表查询、校园活动查询、校园制度问答和学习计划生成。"
SIDEBAR_DESCRIPTION = (
    "校园智能助理项目，基于 LangGraph、FastAPI、Streamlit 和 RAG 构建，"
    "用于连接校园服务、知识库与智能 Agent 能力。"
)
WELCOME_MESSAGE = "你好，我是 Campus AI Agent，可以帮你查询课程表、校园活动、学校制度，并根据你的目标生成学习计划。"
EXAMPLE_QUESTIONS = [
    "我今天有哪些课程？",
    "这周有什么适合软件工程学生参加的活动？",
    "请问请假流程是什么？",
    "挂科后还能评奖学金吗？",
    "帮我制定一份 AI Agent 面试学习计划。",
]
...
async def main() -> None:
    ...
    with st.sidebar:
        ...
        with st.expander("示例问题", expanded=True):
            for idx, question in enumerate(EXAMPLE_QUESTIONS):
                if st.button(question, key=f"example_question_{idx}", use_container_width=True):
                    st.session_state.pending_example_question = question
    ...
    if example_question := st.session_state.pop("pending_example_question", None):
